...
set @MARIADB_REVIEW_VERSION='1.5.6';
...
INSERT INTO `GALERA_MARIADB_VERSIONS` VALUES ('26.4.0','10.4.2'),('26.4.1','10.4.3'),('26.4.11','10.4.22'),
...
if @COLLECT_PROCESSLIST = 'YES' then
  insert into PROCESSLIST (`TICK`,`CONNECTION_ID`,`USER`,`HOST`,`DB`,`COMMAND`,`TIME`,`STATE`,`INFO`,`TIME_MS`,`STAGE`,`MAX_STAGE`,`PROGRESS`,`MEMORY_USED`,`MAX_MEMORY_USED`,`EXAMINED_ROWS`,`QUERY_ID`,`INFO_BINARY`,`TID`)
  select now(), `ID`,`USER`,`HOST`,`DB`,`COMMAND`,`TIME`,`STATE`,`INFO`,`TIME_MS`,`STAGE`,`MAX_STAGE`,`PROGRESS`,`MEMORY_USED`,`MAX_MEMORY_USED`,`EXAMINED_ROWS`,`QUERY_ID`,`INFO_BINARY`,`TID` 
  from information_schema.PROCESSLIST
