...
set @MARIADB_REVIEW_VERSION='1.5.0';
...
select concat('Performance data collection begins in ',(60 -cast(date_format(now(),'%S') as integer)),' seconds and will complete in ',format(@MINUTES_TO_COLLECT_PERF_STATS,0), if(@MINUTES_TO_COLLECT_PERF_STATS=1,' minute.', ' minutes.')) as NOTE;
